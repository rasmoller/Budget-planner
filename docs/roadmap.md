...
| **Future-dated changes** | 📋 Planned | Schedule changes in advance (e.g., "in 3 months I switch from SU to dagpenge") |
...
| **One-time purchases** | Implemented (branch `feat/one-time-purchases`, awaiting merge to `Staging`) |
